 ...
 * 1 on success
 */
export type IdentityVerificationDocumentAdd = number;

/**
 * Add user information with document type, document id, and country that has issued the document.
 */
...
export interface MT5NewAccountRequest {
   ...
   */
  server?: null | ("p01_ts01" | "p01_ts02" | "p01_ts03" | "p01_ts04" | "p02_ts02");
  /**
...
export type ResidenceList = {
  /**
   * Information about identitiy options available
   */
  identitiy?: {
    /**
